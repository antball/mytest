...
public class MainActivity extends FragmentActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        mDrawer_layout.setDrawerShadow(R.drawable.drawer_shadow, GravityCompat.START);
        ...
        mDrawerToggle = new ActionBarDrawerToggle(this, mDrawer_layout, R.drawable.ic_drawer, R.string.hello_world, R.string.app_name)
        {
            @Override
