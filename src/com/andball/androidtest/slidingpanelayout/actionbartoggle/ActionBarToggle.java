 ...
 * 
 * <p>
 * To use <code>ActionBarToggle</code>, create one in your Activity and call
 * through to the following methods corresponding to your Activity callbacks:
 * </p>
 * 
 * <ul>
 * <li>
 ...
 * 
 * <p>
 * <code>ActionBarToggle</code> can be used directly as a
...
public class ActionBarToggle implements DrawerListener, PanelSlideListener
{
    ...
    private static class ActionBarDrawerToggleImplCompat implements ActionBarDrawerToggleImpl
    {
        ...
        {
            return ActionBarToggleCompat.setActionBarUpIndicator(info, activity, themeImage, contentDescRes);
        }

        @Override
        public Object setActionBarDescription(Object info, Activity activity, int contentDescRes)
        {
            return ActionBarToggleCompat.setActionBarDescription(info, activity, contentDescRes);
        }
    }
    ...
    private static class ActionBarDrawerToggleImplHC implements ActionBarDrawerToggleImpl
    {
        ...
        public Object setActionBarUpIndicator(Object info, Activity activity, Drawable themeImage, int contentDescRes)
        {
            return ActionBarToggleHoneycomb.setActionBarUpIndicator(info, activity, themeImage, contentDescRes);
        }

        @Override
        public Object setActionBarDescription(Object info, Activity activity, int contentDescRes)
        {
            return ActionBarToggleHoneycomb.setActionBarDescription(info, activity, contentDescRes);
        }
    }
     ...
     *            accessibility
     */
    public ActionBarToggle(Activity activity, ViewGroup layout, int drawerImageRes, int openDrawerContentDescRes, int closeDrawerContentDescRes)
    {
        mActivity = activity;
     ...
     * the ActionBarToggle was not notified. (For example, if you stop
    ...
    public void syncState()
    {
        ...
        if (mDrawerIndicatorEnabled)
        {
            mSetIndicatorInfo = IMPL.setActionBarUpIndicator(mSetIndicatorInfo, mActivity, mSlider, isViewOpen() ? mOpenDrawerContentDescRes
     ...
     * {@link Activity#onOptionsItemSelected(com.actionbarsherlock.view.MenuItem)
    ...
    /**
     * {@link SlidingPaneLayout.PanelSlideListener} callback method. If you do
     * not use your ActionBarToggle instance directly as your
     * SlidingPaneLayout's listener, you should call through to this method from
     ...
     * 
     * @param panel
     *            The child view that was slid to an open position, revealing
     *            other panes
     */
    @Override
     ...
     * your ActionBarToggle instance directly as your DrawerLayout's listener,
